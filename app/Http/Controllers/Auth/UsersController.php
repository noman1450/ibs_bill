...
class UsersController extends Controller
{
    ...
    {   
      ...
      return view('MasterSetting.users.index');
    }
    ...
    public function create()
    {
      ...
      $role_lists = DB::select("SELECT id,guard_name from roles"); 
       return view('MasterSetting.users.create')
...
// dd($userdata->id);
    ...
    public function edit($id)
    {
       ...
       return view('MasterSetting.users.edit')
        ->with('role_list',$role_lists)
 ...
 public function role()
    {
       ...
       return view('MasterSetting.permission.role');
    }
