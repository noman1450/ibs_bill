                                        ...
                                        <div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 14px;">
                                            <p style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;">
                                                <span style="color: #000000;">
                                                    Reference: <strong>{{ $item->bill_no ?? '' }}</strong>
                                                </span>
                                                <br/>
                                                <span style="color: #000000;">
                                                    Date: {{ date('M d Y', strtotime($item->bill_date)) ?? '' }}
                                                </span>
                                            </p>
                                            ...
                                            <p style="font-size: 14px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><br/>
                                                ...
                                                <br/>
                                                <span style="color: #000000;">
                                                    <b>{{ $item->send_to ?? 'Managing Director' }}</b>
                                                </span>

                                                <br/>

                                                <strong><span style="color: #000000;font-size:18px">{{ ucwords($item->client_name) ?? '' }}</span></strong>

                                                <span style="color: #000000;"></span><br/><span style="color: #000000;font-size: 14px;}"><em>{{ $item->address ?? '49/3 Rajabo, Ghorashal, Palash, Narsingdi' }}</em></span></p>

                                            <p style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><span style="color: #000000;font-size: 12px;">{{ $item->client_email ?? 'email@gmail.com' }}</span></p>
                                        </div>
                                    </div>
                                @endforeach
                                    ...
                                    <div style="padding:0 18px;font-size:16px;text-align:center;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif">
                                        <table id="customers">
                                            ...
                                            @foreach ($collection as $item)
                                                {{-- @php $rj = $item->software_name @endphp --}}
                                                <tr style="font-size:12px;">
                                                    {{-- @if($rj !== $reserve) --}}
                                                        <td style="vertical-align:middle; text-align:center;text-transform:capitalize">
                                                            <strong>{{ $item->software_name }}</strong>
                                                        </td>
                                                        {{-- @php $reserve = $item->software_name @endphp
                                                    @endif --}}
                                                    <td style="font-size:14px;">{{ $item->month_name.'-'.$item->year_id }}</td>
                                                    <td style="font-size:14px;"><b>Tk. {{ $item->payableamount ?? '' }}/=</b></td>
                                                </tr>
                                            ...
                                            <tr class="font-size:14px;">
                                                ...
                                                <td style="font-size:14px"><b>TK. {{ $totalAmount ?? '' }}/=</b></td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <div style="padding-left:18px;margin-top:10px;font-size:12px;color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;line-height:1.2;">
                                        <div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 14px;">
                                            <p style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><span style="color: #000000;">In-Words: <b>{{ ucwords(Terbilang::make($totalAmount)) ?? '' }} only</b></span></p>
                                        </div>
                                    </div>
