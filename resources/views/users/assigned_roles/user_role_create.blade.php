  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      {!! Form::open(['method'=>'POST', 'action'=>['User\AssignedRoleController@add_user_role'], 'onkeypress'=> "return event.keyCode != 13;", 'id'=>'frm_data']) !!}
                  ...
                  <li>
                    <label>
                          ...
                          @if(isset($role) AND $role->roles_id == $role->assigned_roles_id)
                              <input type="checkbox" class="minimal" value="{{$role->roles_id}}" name="role[{{$role->roles_id}}]" checked>
                              {{$role->role_name}}
                          @else
                               <input type="checkbox" class="minimal" value="{{$role->roles_id}}" name="role[{{$role->roles_id}}]" >
                              {{$role->role_name}}
                          @endif 
