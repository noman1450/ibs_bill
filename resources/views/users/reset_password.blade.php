...
<div class="box box-primary">
	...
	<form class="form-horizontal" method="POST" action="{{url('password_reset')}}" onkeypress = "return event.keyCode != 13;" id="frm_data">
		{{ csrf_field() }}
		<div class="box-body">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="col-md-6" >
						...
						<div>
							 <input type="submit" class="btn btn-success btn-flat pull-right mybutton" value="Submit" id="btnSubmit">
						</div>
