...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
  <head>
    ...
    <!-- Select2 -->
    <link href="<?php echo e(asset('admin-lte/plugins/select2/select2.min.css')); ?>" rel="stylesheet" />
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?php echo e(asset('admin-lte/dist/img/user3-128x128.jpg')); ?>" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?php echo e(asset('admin-lte/dist/img/user4-128x128.jpg')); ?>" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                            Developers
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?php echo e(asset('admin-lte/dist/img/user2-160x160.jpg')); ?>" class="user-image" alt="User Image">
...
<?php echo app('toastr')->render(); ?>
    ...
    <!-- FastClick -->
    <script src="<?php echo e(asset('admin-lte/plugins/fastclick/fastclick.min.js')); ?>"></script>
    <!-- AdminLTE App -->
