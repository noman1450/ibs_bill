                    ...
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:#ffffff;">
                        ...
                        <div class="col num12" style="min-width: 320px; max-width: 700px; display: table-cell; vertical-align: top; width: 694px;">
                            <div style="width:100% !important;">
                                ...
                                <?php
                                    $unique = $collection->unique('bill_no');
                                ?>
                                <?php $__currentLoopData = $unique; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 14px;">
                                            <p style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;">
                                                <span style="color: #000000;">
                                                    Reference: <strong><?php echo e($item->bill_no ?? ''); ?></strong>
                                                </span>
                                                <br/>
                                                <span style="color: #000000;">
                                                    Date: <?php echo e(date('M d Y', strtotime($item->bill_date)) ?? ''); ?>
                                            ...
                                            <p style="font-size: 14px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><br/>
                                                ...
                                                <br/>
                                                <span style="color: #000000;">
                                                    <b><?php echo e($item->send_to ?? 'Managing Director'); ?></b>
                                                </span>

                                                <br/>

                                                <strong><span style="color: #000000;font-size:18px"><?php echo e(ucwords($item->client_name) ?? ''); ?></span></strong>

                                                <span style="color: #000000;"></span><br/><span style="color: #000000;font-size: 14px;}"><em><?php echo e($item->address ?? '49/3 Rajabo, Ghorashal, Palash, Narsingdi'); ?></em></span></p>

                                            <p style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><span style="color: #000000;font-size: 12px;"><?php echo e($item->client_email ?? 'email@gmail.com'); ?></span></p>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div style="padding:0 18px;font-size:16px;text-align:center;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif">
                                        <table id="customers">
                                            ...
                                            <?php $__currentLoopData = $collection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr style="font-size:12px;">
                                                        ...
                                                        <td style="vertical-align:middle; text-align:center;text-transform:capitalize">
                                                            <strong><?php echo e($item->software_name); ?></strong>
                                                        </td>
                                                        
                                                    <td style="font-size:14px;"><?php echo e($item->month_name.'-'.$item->year_id); ?></td>
                                                    <td style="font-size:14px;"><b>Tk. <?php echo e($item->payableamount ?? ''); ?>/=</b></td>
                                                </tr>
                                            ...
                                            <tr class="font-size:14px;">
                                                ...
                                                <td style="font-size:14px"><b>TK. <?php echo e($totalAmount ?? ''); ?>/=</b></td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <div style="padding-left:18px;margin-top:10px;font-size:12px;color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;line-height:1.2;">
                                        <div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 14px;">
                                            <p style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><span style="color: #000000;">In-Words: <b><?php echo e(ucwords(Terbilang::make($totalAmount)) ?? ''); ?> only</b></span></p>
                                        </div>
                                    </div>
                                    ...
                                    <div align="right" class="img-container right autowidth" style="padding-right: 18px;padding-left: 0;">
                                        <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0"><td style="padding-right: 0;padding-left: 0;" align="right"><![endif]--><img align="right" alt="" border="0" class="right autowidth" src="https://i-infotechsolution.com/assets/img/logo.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; width: 100%; max-width: 150px; float: none; display: block;" width="150"/>
                                        <br/>
                                        ------------------------------------
...
<?php /**PATH H:\xammp\htdocs\ibs_accounts_mail_version\resources\views/MasterSetting/duecollection/pdf.blade.php ENDPATH**/ ?>